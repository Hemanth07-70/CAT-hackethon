...
MODEL_METRICS = {
    ...
    "event_type_classifier": {
        "algorithm": "XGBoost Multi-class + ADASYN + Feature Engineering",
        "data_size": 654,
        "target": "event_type (6 classes)",
        "improvements": [
            "Switched from Random Forest + SMOTE → XGBoost + ADASYN",
            "Added 9 engineered features: hour_of_day, is_high_temp, is_close_worker, speed_x_distance, etc.",
            "Added response_time_sec and resolved as features",
            "Sample weights inversely proportional to class frequency",
        ],
        "results": {
            "overall_accuracy": 0.8931,
            "weighted_f1": 0.88,
            "accuracy_improvement": "+19.3% over baseline (70% → 89.3%)",
            "per_class": {
                "normal": {"precision": 0.92, "recall": 0.95, "f1": 0.93},
                "proximity_breach": {"precision": 0.81, "recall": 0.85, "f1": 0.83},
                "temp_spike": {"precision": 1.00, "recall": 1.00, "f1": 1.00},
                "erratic_accel": {"precision": 0.50, "recall": 0.25, "f1": 0.33},
                "high_fuel": {"precision": 0.00, "recall": 0.00, "f1": 0.00},
                "overspeed": {"precision": 1.00, "recall": 0.50, "f1": 0.67},
            },
            "top_features": {
                "is_high_temp": 0.275,
                "is_close_worker": 0.234,
                "is_high_speed": 0.101,
                "speed_kmh": 0.060,
                "risk_level": 0.055,
            },
        },
        "note": "high_fuel (12 samples) still needs fuel_rate feature from synthetic data teammate to classify correctly",
        "verdict": "GOOD — 89.3% accuracy. Needs more high_fuel + erratic_accel synthetic samples to push to 95%+",
    },
}
